...
const TOKEN = '8071242223:AAHF5EU-EcodU2AW6kJbkh5lEUb8j4UGg8c';
const CHANNEL = '@NB_Bot_Player';
...
const pageSize = 100;
const OWNERS = ['@NOORBAZOOKA','@BAZOOKAMC', '@FlxDev', "@Ivan_Dev_Trans"];
const requiredChannels = ['@NB_Bot_Player']
